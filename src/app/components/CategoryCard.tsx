...
const CategoryCard = ({
  ...
  return (
    <Link href="/" className="group w-full">
      <div className="relative flex aspect-square min-w-[300px] items-center justify-center transition-all duration-300 ease-in-out lg:group-hover:-translate-y-4 lg:group-hover:shadow-2xl">
